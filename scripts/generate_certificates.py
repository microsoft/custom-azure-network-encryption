...
def create_body(SubjectName, ValidDays, 
                ...
                KeyStrength, KVCertificateName, KVSecretName, VaultBaseUrl, IssuerBase64Pfx):
...
# Generate root CA
root_ca = create_body("CN=www.root.com", 100, True, False, 0, True, 2048, "", "root-ca", vault_url, "")
...
intermediate_ca = create_body("CN=www.intermediate.com", 75, True, False, 0, True, 2048, "", "intermediate-ca", vault_url, root_ca_pfx)
...
for host in hosts:
    ...
    body = create_body("CN=" + host, 50, False, False, 0, True, 2048, host, "", vault_url, intermediate_ca_pfx)
